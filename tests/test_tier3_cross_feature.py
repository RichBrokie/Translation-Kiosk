...
async def test_tc_t3_pair_04_whisper_non_en_detection_qwen_translation():
    ...
    mock_qwen = MockQwenClient(
        default_corrected="En el segundo piso podr??n encontrar cartas.",
...
async def test_tc_t3_pair_12_stitched_text_qwen_correction_4stage_diff():
    ...
    mock_qwen = MockQwenClient(
        default_corrected="ne s'est jamais donn?? les moyens",
    ...
    assert diff_payload["stage_3_corrected"] == "ne s'est jamais donn?? les moyens"
