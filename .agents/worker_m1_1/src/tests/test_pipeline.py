...
- Audio rolling buffer math, chunk accumulation, window slicing, stride, and flush zero-padding
- TextStitcher fuzzy alignment, overlap deduplication, boundary word repair, hallucination filtering
- WhisperClient HTTP parsing, connection pooling, retries, and timeout fallbacks
- QwenClient single-call post-correction, 5-stage JSON parser, and English bypass (0ms overhead)
